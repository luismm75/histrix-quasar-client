  ...
  <q-page class="fit">
    <div class="row">
      ...
      <div class="col-5 right-align">
          <q-btn v-if="schema.export" flat round dense icon="import_export" title="Exportar" @click="$emit('export')" />
          <q-btn flat round dense  icon="print" title="Imprimir" @click="$emit('print')" />
          <q-btn fab color="red" icon="add" title="Nuevo" v-if="canInsert" @click="addItem()" no-caps >
          </q-btn>
      </div>
    </div>
      <div class="row">
