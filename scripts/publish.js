        ...
        fs.readFile(fullPath, 'utf8', (err, data) => {
            ...
            try {
                ...
                if (packageJson.version) {
                    ...
                    newVersion = parseInt(lastSegment, 10) + 1;
...
updateVersion(packageUIPath).then(newVersionA => {
    updateVersion(packageExtensionPath).then(() => {
        ...
        fs.readFile(fullPathB, 'utf8', (err, data) => {
            ...
            try {
                ...
                // Actualizar la dependencia de A en B
                if (packageJsonB.dependencies && packageJsonB.dependencies[namePackageUI]) {
